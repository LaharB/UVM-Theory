...
![alt text](<Section_5_UVM_PHASES/Simulation Results/30.How to override phases.png>)
...
![alt text](<Section_5_UVM_PHASES/Simulation Results/31.Execution of build_phase in multiple components.png>)
...
![alt text](<Section_5_UVM_PHASES/Simulation Results/32.Understanding exec of connect phase.png>)
...
![alt text](<Section_5_UVM_PHASES/Simulation Results/36.Time consuming phases in multiple components.png>)
...
- Here, the drain time will start only after all the main phases of all the components have completed at 350n
...
![alt text](<Section_5_UVM_PHASES/Simulation Results/39.Drain Time - Multiple component.png>)
...
![alt text](<Section_5_UVM_PHASES/Simulation Results/41.Objection Debug Switch Part 1.png>)
![alt text](<Section_5_UVM_PHASES/Simulation Results/41.Objection Debug Switch Part 2.png>)
...
![alt text](<Section_7_Sequence/Simulation Results/51.Undestanding Flow.png>)
...
![alt text](<Section_7_Sequence/Simulation Results/52.Sending data to sequencer METHOD 1.png>)
...
- after this UVM automatically calls wait_for_item and as soon as acknowledgement is received, the next sequence is sen
...
<details>
 <summary><b>55.Changing Arbitration Mechanism</b></summary><br>
...
![alt text](<Section_7_Sequence/Simulation Results/58.Holding Access of Sequencer P3 - Lock Method.png>)
...
<details>
 <summary><b>59.Holding Access of Sequencer P4 - Grab Method</b></summary><br>
